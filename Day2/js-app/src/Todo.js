        ...
        <div>
            <div className="row mb-3">
                <div className="col text-left">
                    <button className="btn btn-primary" onClick={e => handleCompleted(true)}>Completed</button>
                    <button className="btn btn-primary" onClick={e => handleCompleted(false)}>Not Completed</button>
                    <button className="btn btn-primary" onClick={e => handleCompleted()}>All</button>
                </div>
                <div className="col text-right">
                    <input type="text" className="form-control" placeholder="Filter by text"
                        onChange={e => {
